    ...
    return (
        ...
        <div className="flex items-center gap-8 justify-center flex-col" >
            ...
            <div className=' flex items-center gap-3 justify-center flex-col' >
                ...
                <h1 className='text-4xl font-bold text-center mt-10'>Loved by Creators</h1>
                <p className='text-gray-400 text-center'>Don't just take our word for it. Here's what our users are saying.</p>
